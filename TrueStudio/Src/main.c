...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	if (fresult == FR_OK) {
		...
		//sprintf(STR, "480x320//%d.bin", i);
		//int t = drawImage(0, 0, "System//APPS//File_Manager//Music_Player//background.bimg");
		//text(INT_TO_STR(t), 460, 300);
	}
	else {
